...
function SettingsTabNav() {
  ...
  return (
    <SettingBottomTab.Navigator>
            ...
            <SettingBottomTab.Screen name="ChangePassword" component={ChangePassword} options={{tabBarIcon: ({ color }) => <TabBarIcon name="settings-outline" color={color} />, title: 'Account',}}/>
